...
class _ColorHexFieldState extends State<ColorHexField> {
  ...
  Widget build(BuildContext context) {
    final fieldLabel = widget.label ?? context.l10n.productColor;
          ...
          children: [
            Expanded(
              child: TextFormField(
                ...
                validator: (value) {
                  if (!isValidHex(value ?? '')) {
                    return context.l10n.colorPickerInvalidHex;
                  }
                  return null;
                },
                style: AppTextStyles.bodyLarge,
                decoration: InputDecoration(
                  hintText: context.l10n.colorPickerHexHint,
                  prefixText: '#',
                  filled: true,
      ...
      child: CustomPaint(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            color: hasValidColor ? color : Colors.white,
