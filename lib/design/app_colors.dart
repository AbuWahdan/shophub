...
static const Color priceGreen   = Color(0xFF2E7D32);  // price text
static const Color cartIconColor = Color(0xFFFF9800); // cart icon (orange)
static const Color saleBadge    = Color(0xFFE53935);  // red ribbon
// --- Semantic (Status) ---
